        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-globe"></i> All Apps Ltd.
          ...
          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              From
              <address>
                <strong>All Apps Ltd.</strong><br>
                PO Box 31515<br>
                Lower Hutt 5040, Wellington<br>
                Phone: 0800 765 555<br>
                Email: info@allapps.co.nz
              </address>
            </div><!-- /.col -->
            <div class="col-sm-4 invoice-col">
              To
            ...
            <div class="col-sm-4 invoice-col">
              <b>Invoice #INV00015</b><br>
              <br>
              <b>Customer ID:</b> AA10015<br>
              <b>Payment Due:</b> 2/22/2016<br>

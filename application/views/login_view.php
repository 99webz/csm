  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Credit Sales</b> Manager</a>
      </div><!-- /.login-logo -->
...
<!--           <?php {
          ...
          {
            echo "<a href='#'>$row->first_name</a>" . "<br>";
          }
        }
          ?> -->
      ...
      <p class="text-center">Developer Build Version 1.0</p>
    </div><!-- /.login-box -->

    <!-- jQuery 2.1.4 -->
    <script src="<?php echo base_url(); ?>plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="<?php echo base_url(); ?><?php echo base_url(); ?>bootstrap/js/bootstrap.min.js"></script>
    <!-- iCheck -->
